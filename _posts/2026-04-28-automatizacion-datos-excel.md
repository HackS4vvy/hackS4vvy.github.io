...
![Estructura de datos crudos CSV](/assets/img/csv-datos-crudos.png)
...
![Tabla normalizada en Excel](/assets/img/tabla-limpia-excel.png)
...
![Funciones de suma avanzada en Excel](/assets/img/funciones-suma-excel.png)
...
![Motor de búsqueda con BUSCARV en Excel](/assets/img/motor-busqueda-excel.png)
...
![Lógica condicional con Función SI en Excel](/assets/img/funcion-si-excel.png)
...
![Estructura de Tabla dinámica en Excel](/assets/img/estructura-tabla-excel.png)
...
![Funciones de texto y tiempo en Excel](/assets/img/funciones-texto-tiempo.png)
...
![Agregación de datos con Tablas Dinámicas](/assets/img/tablas-dinamicas-excel.png)
...
![Segmentación de datos interactiva en Excel](/assets/img/segmentacion-datos-excel.png)
...
![Boceto de Dashboard en Excel](/assets/img/boceto-dashboard-excel.png)
...
![Dashboard Final de Análisis en Excel](/assets/img/dashboard-final-excel.png)
